<template>
  <div class="box">
      ...
      <van-popup v-model="isShowSelect" position="right" :style="{ width: '80%', height: '100%' }">
         <div class="selectBox">
             <div class="item">
...
export default {
    ...
    created() {
        let arr = this.goods.menuList.filter(item => item.id === this.categoryId)
    ...
    methods: {
     backTop() {
      ...
      async getFirstSelectList() {
          this.selectObj.currentPage = 1
          this.selectObj.storeid = this.storeId
